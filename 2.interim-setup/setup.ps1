...
#$assignee = (az identity show -g $rg -n $aciIdentity --query "clientId" | ConvertFrom-Json)

# Get resource ID of the user-assigned identity
userID = $(az identity show --resource-group $ResourceGroup --name $AciIdentity --query id --output tsv)
